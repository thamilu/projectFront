...
const REVIEWS = [
  {
    ...
    customer: 'Priya S.',
    rating: 5,
    comment: 'Amazing product! Fast shipping.',
    date: '2026-02-22',
  },
  {
    id: '2',
    ...
    customer: 'Rahul M.',
    rating: 4,
    comment: 'Good quality. Slightly large sizing.',
    date: '2026-02-18',
  },
  {
    id: '3',
  ...
  },
  {
    ...
    customer: 'Arjun P.',
    rating: 5,
    comment: 'Premium quality! Exactly as described.',
    date: '2026-02-10',
  },
];
        ...
        <Card>
          <CardContent className="flex items-center gap-4 pt-6">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mt-1 text-xs">{REVIEWS.length} reviews</p>
            </div>
            <div className="flex-1 space-y-1.5">
              {[5, 4, 3, 2, 1].map((s, i) => (
                <div key={s} className="flex items-center gap-2 text-xs">
                  <span className="text-muted-foreground w-3">{s}</span>
                  <Progress value={DIST[i]} className="h-1.5 flex-1" />
                  <span className="text-muted-foreground w-6 text-right">{DIST[i]}%</span>
                </div>
              ))}
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-3 pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-xs">Positive reviews</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-xs">Total reviews this month</p>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="mb-2 flex items-start justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs">{review.product}</p>
                  </div>
                </div>
